...
let favoriteFoods = ['noodles', 'bread', 'sushi', 'smoothie'];
...
console.log('The last animal is', animalArray.length);
//unsure at the moment. might come back
